  ...
  <div class="row">
	...
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="form-group">
			...
			<select name="institution_law_id" id="institution_law_id" class="form-control form-control-sm select2" 
				placeholder="{{ __('planilla.institution_laws') }}" style="width: 100%;" required>
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <div class="form-group">
        ...
        {!! Form::number("from", $lawDiscount->from, ['class' => 'form-control form-control-sm', 'placeholder' => __('planilla.from'), 
        'id' => 'from', 'required'])!!}
      </div>
    </div>
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <div class="form-group">
        ...
        {!! Form::number("until", $lawDiscount->until, ['class' => 'form-control form-control-sm', 'placeholder' => __('planilla.until'), 
        'id' => 'until', 'required'])!!}
      </div>
    </div>
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <div class="form-group">
        ...
        {!! Form::number("base", $lawDiscount->base, ['class' => 'form-control form-control-sm', 'placeholder' => __('planilla.base'), 
        'id' => 'base', 'required'])!!}
      </div>
    </div>
	...
	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
		  ...
		  {!! Form::number("employee_percentage", $lawDiscount->employee_percentage, ['class' => 'form-control form-control-sm', 'placeholder' => __('planilla.employee_percentage'), 
	  ...
	  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
		  ...
		  {!! Form::number("fixed_fee", $lawDiscount->fixed_fee, ['class' => 'form-control form-control-sm', 'placeholder' => __('planilla.fixed_fee'), 
		  'id' => 'fixed_fee', 'required'])!!}
		</div>
	  </div>
	  ...
	  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
		  ...
		  {!! Form::number("employer_value", $lawDiscount->employer_value, ['class' => 'form-control form-control-sm', 'placeholder' => __('planilla.employer_value'), 
...
<div class="modal-footer">
  ...
  <button type="button" class="btn btn-primary" onClick="editInstitutionLaw({{ $lawDiscount->id }})">@lang('planilla.edit')</button>
