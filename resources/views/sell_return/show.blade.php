<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.sell_return') (<b>@lang('sale.invoice_no'):</b> {{ $sell->return_parent->correlative }})
    </h4>
</div>
<div class="modal-body">
   <div class="row">
      <div class="col-sm-6 col-xs-6">
        ...
        <strong>@lang('contact.customer'):</strong> {{ $sell->customer->is_default ? $sell->customer_name : $sell->customer->namecd }} <br>
      ...
      <div class="col-sm-12">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  @php
                    $line_total = $sell_line->unit_price * $sell_line->quantity_returned;
