...
<body>
    ...
    <div class="content">
        ...
        <div class="check-content">
            ...
            <div class="value_letters">{{ $value_letters }}</div>
        </div>
    </div>
    ...
    <div class="page-break">
        <div class="content">
            ...
            <p class="alncenter" style="font-size: 10pt;">
                <strong>{{ mb_strtoupper(__('report.proof_of_check')) }}</strong>
            </p>
            ...
            <div class="check-content-2">
                <div class="place_date">&nbsp;</div>
                <div class="amount">&nbsp;</div>
                <div class="person">&nbsp;</div>
                <div class="value_letters">&nbsp;</div>

                <div class="pay-to">&nbsp;</div>
                <div class="pay-to-2">&nbsp;</div>
            ...
            <table class="table1" style="margin-top: 15px;" width="100%">
                <tr>
                    ...
                    <td class="alnright td2">
                        <strong>{{  __('report.check_no') }}:</strong> {{ $check_number }}
                    </td>
                </tr>
            </table>
            ...
            <div class="concept">
                <div class="concept-label">
                    <strong>@lang('report.concept'):</strong>
                </div>
