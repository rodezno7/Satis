                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            {{ asset('uploads/files/import_products_csv_template_' . auth()->user()->language . '.csv') }}
                            @else
                            {{ asset('uploads/files/import_products_csv_template_en.csv') }}
                            @endif
                            " class="btn btn-success" download><i class="fa fa-download"></i> @lang('product.download_csv_file_template')</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td>22</td>
                            <td>@lang('warehouse.warehouse') <small class="text-muted">(@lang('lang_v1.optional')) <br>@lang('lang_v1.warehouse_ins')</small></td>
                            <td>@lang('lang_v1.warehouse_ins1')<br>
                            </td>
                        </tr>
                        <tr>
                            <td>23</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <strong>@lang('lang_v1.available_options'): kits, product, @if (config('app.business')) service, material @else service @endif</strong>
                            </td>
                        </tr>
                        <tr>
                            <td>36</td>
                            <td>@lang('product.supplier_id') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                            <td>@lang('lang_v1.supplier_id_help_text')</td>
                        </tr>
                        <tr>
                            <td>37</td>
                            <td>@lang('contact.catalogue') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                            <td>@lang('lang_v1.catalogue_help_text')</td>
                        </tr>
                        <tr>
                            <td>38</td>
                            <td>@lang('contact.uxc') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                            <td>@lang('lang_v1.uxc_help_text')</td>
                        </tr>
                        <tr>
                            <td>39</td>
                            <td>@lang('lang_v1.weight') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                            <td>@lang('lang_v1.weight_help_text')</td>
                        </tr>
                        <tr>
                            <td>40</td>
                            <td>@lang('contact.dimensions') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                            <td>@lang('lang_v1.dimensions_help_text')</td>
                        </tr>
                        <tr>
                            <td>41</td>
                            <td>@lang('product.custom_field') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                            <td>@lang('lang_v1.custom_field_help_text')</td>
                        </tr>
                        <tr>
                            <td>42</td>
                            <td>@lang('product.dai') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                            <td>@lang('lang_v1.dai_help_text')</td>
                        </tr>
                        <tr>
                            <td>43</td>
