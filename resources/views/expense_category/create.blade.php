  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="form-group">
        {!! Form::label('name', __( 'expense.category_name' )) !!} <span style="color: red">*</span>
      ...
      <div class="form-group">
        ...
        {!! Form::select('account_id', $expenses_accounts, $expense_account_id->accounting_expense_id, ['class' => 'form-control select2', 'style' => 'width:100%']); !!}
      </div>
    </div>
