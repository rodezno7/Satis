...
<section class="content no-print">
		...
		<div class="box-body">
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="checkbox">
						<label>
							<input type="checkbox" name="print[business_logo]" value="1" id="chk-business-logo" class="chk-logo">
							<b>@lang('barcode.print_business_logo')</b>
						</label>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="checkbox">
						<label>
							<input type="checkbox" name="print[brand_logo]" value="1" id="chk-brand-logo" class="chk-logo">
							<b>@lang('barcode.print_brand_logo')</b>
						</label>
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::select('barcode_setting', $barcode_settings, null, ['class' => 'form-control', 'id' => 'barcode_setting']); !!}
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<button type="button" id="labels_preview" class="btn btn-primary">@lang( 'barcode.preview' )</button>
	...
	<div class="col-sm-8 hide display_label_div">
		...
		<button type="button" class="col-sm-offset-2 btn btn-success btn-block" id="print_label">@lang('lang_v1.print')</button>
	</div>
