...
@section('title', __('accounting.book_sales_taxpayer'))

@section('content')
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('accounting.book_sales_taxpayer')
    </h1>
</section>
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="tab-report">
                    ...
                    {!! Form::open(['id'=>'form_taxpayer', 'action' => 'ReporterController@getBookTaxpayer', 'method' => 'post', 'target' => '_blank']) !!}
                    <div class="row">
                        <div class="col-xs-12">
