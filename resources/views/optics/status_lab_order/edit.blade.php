<div class="modal-dialog" role="document">
  <div class="modal-content" style="border-radius: 10px;">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@lang('status_lab_order.edit_status_lab_order')</h4>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::text('code', $status_lab_order->code,
        ...
        <div class="col-sm-8">
          <div class="form-group">
            ...
            {!! Form::text('name', $status_lab_order->name, ['class' => 'form-control', 'required', 'placeholder' => __('cashier.name')])
            !!}
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="color" id="color" name="color" class="form-control" value="{{ $status_lab_order->color }}">
          </div>
        </div>
        ...
        <div class="col-sm-8">
          <div class="form-group">
            ...
            {!! Form::select('status',
              ...
              $status_lab_order->status, ['class' => 'form-control select2', 'style' => 'width: 100%;']) !!}
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            {!! Form::select('steps[]', $status_list, $status_selected,
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            {!! Form::textarea('descripction', $status_lab_order->descripction,
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                  {!! Form::checkbox('is_default', 1, $status_lab_order->is_default, ['id' => 'is_default']) !!}
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                  {!! Form::checkbox('print_order', 1, $status_lab_order->print_order, ['id' => 'print_order']) !!}
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                  {!! Form::checkbox('transfer_sheet', 1, $status_lab_order->transfer_sheet, ['id' => 'transfer_sheet']) !!}
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                  {!! Form::checkbox('second_time', 1, $status_lab_order->second_time, ['id' => 'second_time']) !!}
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                  {!! Form::checkbox('material_download', 1, $status_lab_order->material_download, ['id' => 'material_download']) !!}
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                  {!! Form::checkbox('save_and_print', 1, $status_lab_order->save_and_print, ['id' => 'save_and_print']) !!}
