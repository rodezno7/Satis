<div class="modal-dialog modal-xl" role="document">
			...
			<div class="nav-tabs-custom">
			  ...
			  <div class="tab-content">
				<div class="active tab-pane" id="general">
				  @include('optics.product.partials.tab_general')
				</div>
  
				<div class="tab-pane" id="cost">
				  @if ($product->type == 'single')
					@include('optics.product.partials.single_product_details')
				  @else
					@include('optics.product.partials.variable_product_details')
				  @endif
				  @include('optics.product.partials.last_purchases')
				</div>
  
				<div class="tab-pane" id="stock">
				  @include('optics.product.partials.tab_stock')
				</div>
  
				<div class="tab-pane" id="sale_price">
				  @include('optics.product.partials.tab_sale_price')
				</div>
  
				<div class="tab-pane" id="price_list">
				  @include('optics.product.partials.tab_price_list')
				</div>
			  </div>
			</div>
			<!-- /.nav-tabs-custom -->
  ...
  {{--
  @include('optics.product.partials.product_detail_print')
  --}}
