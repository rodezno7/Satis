...
<div class="row">
  <div class="col-sm-12">
    ...
    <div class="text-center">
      <div class="btn-group">
        <button id="opening_stock_button" @if ($product->enable_stock == 0) disabled @endif
          type="submit" value="submit_n_add_opening_stock" class="btn bg-purple submit_form">
          @if ($action == 'view')
          @lang('lang_v1.save_n_view_opening_stock') 
          @else
