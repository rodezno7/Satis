<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    {!! Form::open(['url' => action('Optics\ProductController@saveQuickProduct'), 'method' => 'post', 'id' => 'quick_add_product_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="row">
        <div class="form-group col-sm-11 col-sm-offset-1">
          @include('optics.product.partials.single_product_form_part', ['profit_percent' => $default_profit_percent])
        </div>
      </div>
      @if(!empty($product_for) && $product_for == 'pos')
        @include('optics.product.partials.quick_product_opening_stock', ['locations' => $locations])
      @endif
    </div>
