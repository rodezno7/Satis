    ...
    <table>
        ...
        <tbody>
            ...
            @foreach ($transactions as $t)
                ...
                @endphp
                @if ($id != $t->customer_id )
                    @php $counter = $transactions->where('customer_id', $t->customer_id)->count(); @endphp
                ...
                @endif
                <tr>
                    <td class="border-left">{{ $t->correlative }}</td>
