<div class="modal-dialog modal-md modal-dialog-centered" role="dialog">
    <div class="modal-content" style="border-radius: 10px;">
        {!! Form::open(['url' => action('QuoteController@updateLostSale', [$lost_sale->id]), 'method' => 'post', 'id' => 'lost_sale_edit_form']) !!}

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            <h4 class="modal-title">@lang('quote.edit_lost_sale')</h4>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('reason_id', $reasons, $lost_sale->reason_id, ['class' => 'form-control select2', 'style' => 'width:100%', 'required', 'placeholder' => __('messages.please_select')]) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="comments" style="max-width: 100%" class="form-control" required
                            placeholder="Explicación">{{ $lost_sale->comments }}</textarea>
                    </div>
                </div>
            </div>
        </div>
