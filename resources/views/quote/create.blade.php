    ...
    <div class="box-body">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h4>@lang('quote.add_quote')</h4>

                {!! Form::hidden("quote_ref_no", $correlative, ["id" => "ref_no", 'readonly']) !!}
            </div>
        </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select("tax_detail", $tax_detail, null,
                            ["class" => "form-control", "id" => "tax_detail"]) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-3 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('price_group_id', $prices_group, null,
                            ['class' => 'select2 form-control', 'id' => 'selling_price_group_id']) !!}
                    </div>
                </div>
            </div>
    ...
    <div class="box-body">
        ...
        <div id="service-blocks">
            ...
            @foreach ($service_blocks as $service_block)
                @include('quote.partials.service_block', [
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                <div class="form-group">
                    {!! Form::hidden("discount_amount", null,
                        ["class" => "form-control four_decimals", "id" => "discount_amount"]) !!}
                    {!! Form::text("discount_amount_s", null,
                        ["class" => "form-control four_decimals", "id" => "discount_amount_s"]) !!}
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                <div class="form-group">
                    {!! Form::hidden("total_before_tax", null,
                        ["class" => "form-control four_decimals", "id" => "total_before_tax", 'readonly']) !!}
                    {!! Form::text("total_before_tax_s", null,
                        ["class" => "form-control four_decimals", "id" => "total_before_tax_s", 'readonly']) !!}
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                <div class="form-group">
                    {!! Form::hidden("tax_amount", null,
                        ["class" => "form-control four_decimals", "id" => "tax_amount", 'readonly']) !!}
                    {!! Form::text("tax_amount_s", null,
                        ["class" => "form-control four_decimals", "id" => "tax_amount_s", 'readonly']) !!}
                </div>
            </div>
        </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        {!! Form::hidden("total_final", null,
                            ["class" => "form-control four_decimals", "id" => "total_final", 'readonly']) !!}
                        {!! Form::text("total_final_s", null,
                            ["class" => "form-control four_decimals", "id" => "total_final_s", 'readonly']) !!}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>@lang('quote.notes')</label>
                    {!! Form::textarea('note', null,
                        ['class' => 'form-control', 'rows' => 1, 'id' => 'note']) !!}
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>@lang('quote.terms_conditions')</label>
                    {!! Form::textarea('terms_conditions', null,
                        ['class' => 'form-control', 'rows' => 1, 'id' => 'terms_conditions']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <button type="submit" class="btn btn-primary pull-right" id="btn-add-quote">
                    @lang('messages.save')
                </button>
            </div>
        </div>
