<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('CategoryController@store'), 'method' => 'post', 'id' => $quick_add ? 'quick_add_category_form' : 'category_add_form' ]) !!}
    ...
    <div class="modal-body">
      ...
      @if(!empty($parent_categories))
        <div class="form-group" id="div_add_as_sub_cat">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('add_as_sub_cat', 1, false,
                  ['class' => 'toggler', 'data-toggle_id' => 'parent_cat_div', 'id' => 'add_as_sub_cat']); !!}
