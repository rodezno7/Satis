<div class="modal-dialog modal-lg" role="dialog">
    <div class="modal-content" style="border-radius: 10px;">
        {!! Form::open([
            'url' => action('RetentionController@update', [$retention->id]),
            'method' => 'put',
            'id' => 'retention_edit_form'
        ]) !!}
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('retention.edit_retention')</h4>
        </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('transaction_date', @format_date($retention->transaction_date),
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('document_date', @format_date($retention->document_date),
                                ['class' => 'form-control datepicker1', 'readonly', 'required']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('customer_id', $select_customer, $retention->customer_id,
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('ref_no', $retention->ref_no,
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('serie', $retention->serie,
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('additional_notes', $retention->additional_notes,
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('final_total', $retention->final_total,
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('retention', number_format($retention->final_total * 0.01, 4),
