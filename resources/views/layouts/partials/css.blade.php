...
<link rel="stylesheet" href="{{ asset('AdminLTE/plugins/pace/style.css?v='.$asset_v) }}">
...
<link rel="stylesheet" href="{{ asset('AdminLTE/plugins/iCheck/flat/blue.css?v='.$asset_v) }}">
...
<!-- Bootstrap file input -->
<link rel="stylesheet" href="{{ asset('plugins/bootstrap-fileinput/fileinput.min.css?v='.$asset_v) }}">
<script src="{{ asset('plugins/dist/sweetalert.min.js') }}"></script>
...
<link rel="stylesheet" href="{{ asset('plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css?v='.$asset_v) }}">
<link rel="stylesheet" href="{{ asset('accounting/css/jquery-confirm.min.css?v='.$asset_v) }}">
@yield('css')
<!-- app css -->
<link rel="stylesheet" href="{{ asset('css/app.css?v='.$asset_v) }}">
