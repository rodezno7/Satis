...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li
        class="treeview {{ in_array($request->segment(1), [
          'roles',
          'modules',
          'employees',
          'positions',
    ...
    @endcan
      ...
      <li class="treeview @if( in_array($request->segment(1), ['fixed-assets', 'fixed-asset-types']) ) {{'active active-sub'}} @endif">
        <a href="#">
  ...
  class="treeview {{ in_array($request->segment(1), [
    ...
    <ul class="treeview-menu">
      ...
      <li class="{{ $request->segment(1) == 'claims' ? 'active' : '' }}">
        <a href="{{action('ClaimController@index')}}"><i class="fa fa-comments-o"></i> <span>@lang('crm.claims')</span></a>
      </li>
      @endcan
      @can('quotes.access')
        ...
        <ul class="treeview-menu">
          ...
          <li class="{{ $request->segment(2) == 'external-labs-report' ? 'active' : '' }}">
            <a href="{{ action('ReportController@getExternalLabsReport') }}">
              <i class="fa fa-external-link-square" aria-hidden="true"></i> @lang('lab_order.external_laboratory_work')
            </a>
          </li>
          @endcan
      ...
      @if (
        ...
        class="treeview {{in_array($request->segment(1), [
          ...
          <li class="{{ $request->segment(1) == 'apportionments' ? 'active' : '' }}">
            <a href="{{ action('ApportionmentController@index') }}"><i class="fa fa-arrows-alt" aria-hidden="true"></i>@lang('apportionment.apportionment')</a>
          </li>
          @endif

          @can('supplier.view')
          <li class="{{ $request->input('type') == 'supplier' ? 'active' : '' }}">
            <a href="{{action('ContactController@index', ['type' => 'supplier'])}}"><i class="fa fa-building-o" aria-hidden="true"></i>@lang('report.supplier')</a></li>
            @endcan

            {{-- Payment commitment --}}
            @if(auth()->user()->can('payment_commitment.view'))
            <li class="{{ $request->segment(1) == 'payment-commitments' ? 'active' : '' }}">
              <a href="{{action('PaymentCommitmentController@index')}}"><i class="fa fa-file-text-o" aria-hidden="true"></i>@lang('contact.payment_commitment')</a>
            </li>
            @endcan
            ...
            <li class="{{ ($request->segment(1) == 'purchases' && $request->segment(2) == 'debts-to-pay-report') ? 'active' : '' }}">
              <a href="{{action('PurchaseController@debtsToPay')}}"><i class="fa fa-money"></i>@lang('contact.debts_to_pay')</a></li>
              @endcan
...
{{-- @if(auth()->user()->can('cxc.access'))
  ...
  <li
  class="treeview {{ in_array($request->segment(1), ['orders_planner']) ? 'active active-sub' : '' }}"
  id="tour_step4">
  <a href="#" id="tour_step4_menu"><i class="fa fa-line-chart" aria-hidden="true"></i><span>@lang('lang_v1.logistic')</span>
    <span class="pull-right-container">
      <i class="fa fa-angle-left pull-right"></i>
    </span>
  </a>
              ...
              @if (
                ...
                <ul class="treeview-menu" id="tour_step3">
                  ...
                  @if (
                    ...
                    <li class="treeview @if( in_array($request->segment(1), ['documents', 'correlatives']) ) {{'active active-sub'}} @endif">
                  ...
                  <li class="treeview @if (in_array($request->segment(1), ['diagnostic']) ) {{ 'active active-sub' }} @endif">
                    ...
                    <ul class="treeview-menu">
                      <li class="{{ $request->segment(1) == 'diagnostic' ? 'active' : '' }}">
                        <a href="{{ action('Optics\DiagnosticController@index') }}"><i class="fa fa-heartbeat"></i> @lang('diagnostic.diagnostics')</a>
                      </li>
                    </ul>
                  </li>
                  @endcan
                      ...
                      <li class="{{ $request->segment(1) == 'printers' ? 'active' : '' }}">
                        ...
                        <li class="{{ $request->segment(1) == 'tax-rates' ? 'active' : '' }}">
                          ...
                          <li class="treeview @if (in_array($request->segment(1), ['kardex']) ) {{ 'active active-sub' }} @endif">
                            ...
                            <ul class="treeview-menu">
                              <li class="{{ $request->segment(1) == 'kardex' && $request->segment(2) == 'get-recalculate-cost' ? 'active' : '' }}">
