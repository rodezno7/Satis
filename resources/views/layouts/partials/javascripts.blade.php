...
<![endif]-->
<script src="{{ asset('js/polyfill.min.js?v=' . $asset_v) }}"></script>

<script src="{{ asset('AdminLTE/plugins/pace/pace.min.js?v=' . $asset_v) }}"></script>

<script src="{{ asset('js/pdfobject.min.js?v=' . $asset_v) }}"></script>
...
<script src="{{ asset('js/sweetalert2.js?v=' . $asset_v) }}"></script>

<script src="{{ asset('plugins/sweetalert/sweetalert.min.js?v=' . $asset_v) }}"></script>

{{-- jQuery Mask --}}
<script src="{{ asset('plugins/jquery-mask/jquery.mask.min.js?v=' . $asset_v) }}"></script>
...
<script src="{{ asset('plugins/jquery.hotkeys.js?v=' . $asset_v) }}"></script>

<script src="{{ asset('plugins/screenfull.min.js?v=' . $asset_v) }}"></script>
{{--<script src="{{ asset('js/contacts.js?v=' . $asset_v) }}"></script>--}}

<script src="{{ asset('accounting/js/jquery-confirm.min.js?v=' . $asset_v) }}"></script>
