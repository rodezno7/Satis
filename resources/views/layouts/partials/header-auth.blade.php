...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="header-left-div">
		        <select class="select90" id="change_lang">
	...
	<div class="row">
	    <!-- <h1 class="text-center  page-header">{{ config('app.name', 'Envex ERP') }}</h1> -->

        <div style="color: azure" class="header-right-div">
	        ...
	        @if(!($request->segment(1) == 'business' && $request->segment(2) == 'register') && $request->segment(1) != 'login')
	        	{{ __('business.already_registered')}} <a style="color:bisque;  text-decoration:underline " href="{{ action('Auth\LoginController@login') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif">{{ __('business.sign_in') }}</a>
	        @endif
        </div>
	</div>
</div>