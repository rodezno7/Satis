				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							@endphp
							{!! Form::text('transaction_date', @format_date($transaction_date), ['class' => 'form-control', 'id' => 'format_date', 'readonly', 'required']); !!}
						</div>
					</div>
				</div>
				<div class="col-sm-12">
					<table class="table bg-gray" id="purchase_return_table">
				        ...
				        <tbody>
				            ...
				            <tr>
				              	...
				              	<td><span class="display_currency" data-currency_symbol="true" data-precision="4">{{ $purchase_line->purchase_price }}</span></td>
				              	...
				              	<td>
						            ...
						            @if($purchase_line->product->enable_stock) 
				              		...
				              		@endif
						            >
						            <input type="hidden" class="unit_price" value="{{ $purchase_line->purchase_price }}">
				              	</td>
				              	<td>
