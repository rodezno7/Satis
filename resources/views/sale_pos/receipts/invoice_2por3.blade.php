<style>
	...
	div#header { height: 1.8cm; width: 100%; }
	...
	div#details { height: 5.2cm; padding-left: 2cm;/*border: 1px solid #000;*/}
	div#extra-details { position: relative; height: 0.8cm; }
	div#extra-details #discount-text { position: absolute; left: 14.71cm; top: 0.1cm; padding-left: 0.2cm; }
	div#extra-details #discount-amount { position: absolute; left: 17.81cm; top: 0.1cm; width: 1.2cm; text-align: right; }
	@else
	div#details { height: 6cm; padding-left: 2cm;/*border: 1px solid #000;*/}
	@endif
