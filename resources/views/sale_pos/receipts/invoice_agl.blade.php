<style>
	...
	div#details table#sell_lines thead th { height: 0.75cm; }
...
<div id="container">
	...
	<div id="header">
		<table id="header">
			<tr>
				<td style="padding-left: 1.5cm; width: 9.5cm" class="cutter">{{ $receipt_details->customer_name }}</td>
				<td style="padding-left: 1.2cm; width: 3.5cm">{{ @format_date($receipt_details->invoice_date) }}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="padding-left: 1.5cm;">{{ $receipt_details->customer_nit }}</td>
			</tr>
		</table>
	</div>
	<div id="details">
