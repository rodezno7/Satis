          ...
          {{-- HEAD --}}
              ...
              <table style="margin-top: 0.2cm;">
                  <tr>
                      ...
                      <td style="width: 8cm;" class="cutter">{{ $receipt_details->customer_name }}</td>
                      <td style="width: 4cm;"><b>FECHA</b></td>
                      <td>{{ @format_date($receipt_details->invoice_date) }}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      ...
                      <td>{{ $receipt_details->customer_landmark }}</td>
                      <td><b>VENTA A CUENTA DE</b></td>
              ...
              <div class="details">
                    <table class="sell_lines">
                          ...
                          <tbody>
                                ...
                                <tr>
                                      {{-- CANTIDAD --}}
                                      <td class="cutter text-right" style="padding-right: 0.35cm">
                                            {{ $line['quantity'] }}
                                      </td>
  
                                      {{-- DESCRIPCION --}}
                                      <td @if (empty($line['sell_line_note'])) class="cutter" @endif style="padding-left: 0.3cm">
                                            {{ "(". $line['code'] .") ". $line['name'] }} {{$line['variation'] }}
                      ...
                      @if (isset($line['spare_rows']))
                          ...
                          <tr>
                              ...
                              {{-- DESCRIPCION --}}
                              <td @if (empty($spare_row['sell_line_note'])) class="cutter" @endif style="padding-left: 0.3cm">
                                  ...
                                  @if (!empty($spare_row['sell_line_note']))
                                      <br>
                                      {{ $spare_row['sell_line_note'] }}
                                  @endif
                              </td>
              ...
              <table>
                  <tr>{{-- SUMAS --}}
                      <td rowspan="3" style="padding-left: 0.7cm; vertical-align: top; font-size: 6pt;">{{ $receipt_details->total_letters }}</td>
                      <td rowspan="6" style="width: 2.35cm;">&nbsp;</td>
