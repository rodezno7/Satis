					...
					<div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
								...
								{!! Form::select('discount_type_modal', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], $discount_type,
									['class' => 'form-control', 'id' => "discount_type_modal", 'placeholder' => __('messages.please_select'), 'required']); !!}
				            </div>
				        </div>
				    </div>
				        ...
				        <div class="form-group">
				            ...
				            <div class="input-group">
								...
								{!! Form::text('discount_amount_modal', @num_format($sales_discount),
									['class' => 'form-control input_number', 'id' => 'discount_amount_modal']); !!}
				            </div>
				        </div>
				    </div>
