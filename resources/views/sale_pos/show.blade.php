...
<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> @lang('sale.sell_details') (<b>@lang('sale.invoice_no'):</b> {{ $sell->correlative }})
    </h4>
</div>
<div class="modal-body">
    ...
    <div class="row">
      <div class="col-sm-4">
        <b>{{ __('sale.invoice_no') }}:</b> #{{ $sell->correlative }}<br>
        <b>{{ __('sale.status') }}:</b> 
      ...
      <div class="col-sm-4">
        <b>{{ __('sale.customer_name') }}:</b> {{ $customer->name }}<br>
          ...
          <table class="table bg-gray">
            ...
            @foreach($sell->sell_lines as $sell_line)
              <tr>
                ...
                <td>
                  <span class="display_currency" data-currency_symbol="true" data-precision="{{ $price_precision }}">{{ $sell_line->unit_price_before_discount }}</span>
                </td>
                <td>
            ...
            <tr>
              ...
              <td class="text-right">
                @if(!empty($order_taxes))
                  <span class="display_currency pull-right" data-currency_symbol="true">{{ $order_taxes }}</span><br>
