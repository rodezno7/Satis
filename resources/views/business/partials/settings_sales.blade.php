    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('type_discount', __('sale.type_discount') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-info"></i>
                    </span>
                    {!! Form::select('type_discount', ['percentage' => __('sale.percentage'), 'permanent' => __('sale.permanent')], $business->type_discount, ['class' => 'form-control select2', 'placeholder' => __('sale.type_discount'), 'style' => 'width: 100%;', 'id' => 'type_discount']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('default_sales_discount', $business->default_sales_discount, ['class' => 'form-control', 'min' => 0, 'step' => 0.01, 'max' => 100, 'id' => 'default_sales_discount']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('limit_discount', __('sale.limit_discount') . ':*') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-info"></i>
                    </span>
                    {!! Form::number('limit_discount', $business->limit_discount, ['class' => 'form-control', 'min' => 0, 'step' => 0.01, 'max' => 100, 'id' => 'limit_discount']) !!}
                </div>
            </div>
        </div>
