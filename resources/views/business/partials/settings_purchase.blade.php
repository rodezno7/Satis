...
<div class="pos-tab-content">
    ...
    {{-- Enable editing average cost from purchase --}}
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('enable_editing_avg_cost_from_purchase', 1, $business->enable_editing_avg_cost_from_purchase, 
                [ 'class' => 'input-icheck']); !!} {{ __( 'purchase.enable_editing_avg_cost_from_purchase' ) }}
              </label>
            </div>
        </div>
    </div>

    {{-- 'product_settings[decimals_in_purchases]', --}}
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('decimals_in_purchases', __('business.decimals_in_purchases') . ':') !!}
            @show_tooltip(__('tooltip.decimals_in_purchases_tooltip'))
