        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">@lang('new_values.title')</a></li>
            </ul>
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_2">
               ...
               <div class="tab-pane" id="tab_3">
                <div class="row">
                    <div class="col-md-12">
                        <h4>@lang( 'new_values.discount_text' ) <a class="btn btn-primary pull-right" href="{{action('InvoiceLayoutController@create')}}">
                                <i class="fa fa-plus"></i> @lang( 'messages.add' )</a></h4>
                    </div>
                    <div class="col-md-12">
                      <div class="table-responsive">

                        {!! Form::open(['url' => action('InvoiceSchemeController@UpdateDiscoount'), 'method' => 'post','id'=> 'updateDiscount']) !!}
                            @if($discount->count() > 0)
                            <div class="form-group">
                            {!! Form::label('id', __( 'lang_V1.correlative' ) . ':*') !!}
                              {!! Form::text('id', $discount[0]->id, ['readonly' => 'true','class' => 'form-control', 'required', 'placeholder' => __( 'lang_V1.discount_name')]); !!}
                          </div>
                            <div class="form-group">
                            {!! Form::label('discounts_name', __( 'lang_V1.discount_name' ) . ':*') !!}
                              {!! Form::text('discounts_name', $discount[0]->discounts_name, ['readonly' => 'true','class' => 'form-control', 'required', 'placeholder' => __( 'lang_V1.discount_name' )]); !!}
                          </div>
                          <div class="form-group">
                            {!! Form::label('value_', __( 'lang_V1.discount_value' ) . ':*') !!}
                              {!! Form::text('value_', $discount[0]->value_, ['class' => 'form-control', 'required', 'placeholder' => __( 'lang_V1.discount_value' )]); !!}
                          </div>
                          @else
                           <div class="form-group">
                            {!! Form::label('id', __( 'lang_V1.correlative' ) . ':*') !!}
                              {!! Form::text('id', 0, ['readonly' => 'true','class' => 'form-control', 'required', 'placeholder' => __( 'lang_V1.discount_name')]); !!}
                          </div>
                            <div class="form-group">
                            {!! Form::label('discounts_name', __( 'lang_V1.discount_name' ) . ':*') !!}
                              {!! Form::text('discounts_name', 'Descuento', ['readonly' => 'true','class' => 'form-control', 'required', 'placeholder' => __( 'lang_V1.discount_name' )]); !!}
                          </div>
                          <div class="form-group">
                            {!! Form::label('value_', __( 'lang_V1.discount_value' ) . ':*') !!}
                              {!! Form::text('value_', 0, ['class' => 'form-control', 'required', 'placeholder' => __( 'lang_V1.discount_value' )]); !!}
                          </div>


                          @endif

                               <a type="submit" onclick="AddDiscount()" class="btn btn-primary">Descuento</a>
...
@section('javascript')
    <script src="{{ asset('js/add_discount_card.js') }}"></script>
@endsection
