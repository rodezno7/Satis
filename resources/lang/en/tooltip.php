...
return [
    ...
    */
    ...
    'total_checks' => 'Total number of cheques used in this register',
    ...
    'subtract_sell_return' => 'Subtract returns amount from the total shown in the accounts receivable box',
    'box_exc_tax' => 'Show amount of boxes and charts of sales and purchases without taxes',
    'reservation_help_text' => 'Reservations pending invoicing',
    'decimals_in_pos_tooltip' => 'Number of decimals that can be displayed in the prices that appear in the POS',
    'decimals_in_fiscal_documents_tooltip' => 'Number of decimals that can be displayed in the prices that appear in the fiscal documents',
    'decimals_in_purchases_tooltip' => 'Number of decimals that can be displayed in the costs that appear in the purchase module',
    'load_in_physical_inventory_tooltip' => 'Number of months to consider in option to automatically load products in physical inventory.<br>Ex: When placing 2, when checking the option to automatically load products in the physical inventory form, only those products that have had rotation in the last 2 months will be considered.',
    'show_costs_or_prices_tooltip' => 'Define if the costs or prices of the products are shown or hidden in stock transfers and adjustments',
