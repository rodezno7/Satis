...
return [
    ...
    "report_small_business_owner" => "Repor Small business owner",
    ...
    'product_sell_report_small_business_owner' => 'Product Sell Report small business owner',
    ...
    "reset_password_directions" => "Enter the verified email address of your user account and we will send you a link to reset your password.",
    'email_address' => 'E-Mail Address',
    'send_password_reset_link' => 'Send Password Reset Link',
    'instructions' => 'Instructions',
    'instruction_line1' => 'Follow the instructions carefully before importing the file.',
    'instruction_line2' => 'The columns of the XLSX file must be in the indicated order.',
    ...
    "sku_ins_2" => "Product SKU. You must be registered in the system. It will be used to identify the product to edit.",
    ...
    'import_contacts' => 'Import Suppliers',
    ...
    'code_ins' => 'Leave blank to auto generate the Code',
    ...
    'purchase_return_discount' => 'Return discount',
    ...
    'sub_total' => 'Sub Total: ',
    'discount' => 'Discount: ',
    'sub_total_discount' => 'Total without discount: ',
    'iva' => 'IVA: ',
    ...
    "correlatives_help_text" => "Printed document correlative",
    'tooltip_enable_password_manual' => 'Check to generate manual password',
    'tooltip_enable_password_generated' => 'Check to generate automatic password',
    'label_password_automatic' => 'Automatic password',
    'label_password_manual' => 'Manual password',
    'status_user' => 'Status',
    'language_user' => 'Language',
    "enable_unit_group" => "Enable measure groups",
    'products' => 'Products',
    'contacts' => 'Contacts',
    'type' => 'Type',
    'no_records' => 'There are no records to show',
    'supplier_id_help_text' => 'Supplier Contact ID',
    'warehouse_ins' => 'When leaving empty, the first warehouse that is registered is used',
    'warehouse_ins1' => 'Warehouse code',
    'catalogue_help_text' => 'Supplier Catalog',
    'uxc_help_text' => 'UXC of the product offered by the supplier',
    'weight_help_text' => 'Weight of the product offered by the supplier',
    'dimensions_help_text' => 'Dimensions of the product offered by the supplier',
    'custom_field_help_text' => 'Custom field for the product offered by the supplier',
    'dai_help_text' => 'Tariff Duties on Importation',
    'warranty_help_text' => 'Warranty',
    'annulled' => 'Annulled',
    'select_warehouse' => 'Select warehouse',
    'select_cashier' => 'Select cashier',
    'logistic' => 'Logistic',
    'management_sells' => 'Sales management',
    'purchases_imports' => 'Purchases and imports',
    'debs_to_pay' => 'Debts to pay',
    ...
    'instruction_line3' => 'The file to upload must be a comma delimited XLSX.',
    'instruction_line4' => 'If the field is null or does not apply, leave it empty.',
    'required_or_optional_dui' => 'Required if you are not a taxpayer.',
    'required_or_optional_taxpayer' => 'Required if you are a taxpayer.',
    'required_or_optional_taxes' => 'Required if the business type is "Big company".',
    'unique_field_dui' => 'The DUI must be unique in each row and must not have been previously registered.',
    'unique_field_tax_number' => 'The NIT must be unique in each row and must not have been previously registered.',
    'unique_field_reg_number' => 'The registration number must be unique in each row and must not have been previously registered.',
    'required_tax_group' => 'The tax is required in row no. :number',
    'customers_imported' => 'customers',
    'available_options_payment_condition' => 'Available options: cash for cash and credit for credit',
    'required_if_payment_condition_credit' => 'Required if the payment condition is credit',
    'unique_field_nrc' => 'The NRC must be unique in each row and must not have been previously registered.',
    'credit_limit_option' => 'Keep blank is unlimited',
    'contact_taxes' => 'Taxes will not be detailed if it is exempt',
    'required_if_is_not_exempt' => 'Required if not exempt',
    'transfer_from' => 'From',
    'transfer_to' => 'To',
    'created' => 'Created',
    'processed' => 'Processed and shipped',
    'received' => 'Received',
    'accounted' => 'Accounted',
    'remission' => 'Remission',
    'receive' => 'Receive',
    ...
    'entrie_added_successfully' => 'Accounting entrie created successfully',
    'enable_remission_note' => 'Enable remission note',
    'tooltip_enable_remission_note' => 'Allows you to print a remission note on transfers',
    'import-price-list' => 'Import Prices List',
    'yes' => 'Yes',
    'no' => 'No',
    "credits_and_payments" => "Credits and payments",
    "remove" => "Remove",
    'bank_reconciliation_instructions' => 'The Uploaded file must be .xlsx and columns format must be text, as follows:',
    'date_instruction' => 'Date format: dd/mm/aaaa',
    'reference' => 'Reference',
    'reference_instruction' => 'Transaction reference',
    'description_instruction' => 'Descripción de la transacción',
    'amount' => 'Amount',
    'amount_instruction' => 'Transaction amount, format: 0000.00',
    'attach_file' => 'Attach file',
    'transaction_date_required' => 'Transaction date required at row number :row',
    'transaction_date_invalid_format' => 'Transaction date format invalid at row number :row',
    'transaction_reference_required' => 'Transaction reference required at row number :row',
    'transaction_amount_required' => 'Transaction amount required at row number :row',
    'transaction_amount_nan' => 'Transaction amount not a number a row number :row',
    'payment_condition_ins' => 'Available Options: 0 => Cash, 1 => Credit',
    'required_if_condition_credit' => 'Required if payment condition is credit.',
    'is_exempt_ins' => 'Available Options: 0 => No, 1 => Yes.',
    'mail_sent_successfully' => 'Mail sent successfully',
    'close_to_expire' => 'close to expire',
    'more_information' => 'More Information',
    'default' => 'Default',
    'physical_inventory_record_date' => 'Physical inventory record date',
    ...
    'female' => 'Female',
	'male' => 'Male',
    'view_opening_stock' => 'View opening stock',
    'editing' => 'Editing',
    'your_ip' => 'Connected IP: ',
    'search_service_placeholder' => 'Enter service name / SKU / Scan bar code',
    "stock" => "Stock",
    "inputs" => "Inputs",
    "outputs" => "Outputs",
    "initial" => "Initial",
    ...
    "start" => "Start",
	"end" => "End",
    "show_expenses_on_sales_report" => "Show expenses on Sales Report",
    "status_ins" => "Product status",
    "purchase_price_exc_tax_ins_min" => "Purchase Price (Excluding Tax) (Only in numbers)",
    "recommended" => "Recommended",
    "sheet" => "Sheet",
    "development" => "Development",
    "show_costs_or_prices" => "Show costs or prices",
    "costs" => "Costs",
    "prices" => "Prices",
    "update_n_add_opening_stock" => "Update & add opening stock",
	"update_n_view_opening_stock" => "Update & view opening stock",
    "instruction_line5" => "If after processing the file no errors are found, press the Import button to register.",
    "instruction_line6" => "If the field is left empty, the product will keep the value that it already has registered in that field.",
    "model_ins" => "Product model",
    "measurement_ins" => "Product measurements",
    "material_ins" => "Product material",
    "upper_lower_no_matter" => "Use of uppercase or lowercase does not matter",
    "weight_ins" => "Product weight",
    "print" => "Print",
    "charts" => "Charts",
    "image_ins" => "Image name including extension",
