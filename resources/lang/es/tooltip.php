<?php 
 return [ 
    ...
    "total_checks" => "Número total de cheques utilizados en este registro",
    ...
    'sub_sku' => "Sku es opcional. <br><br><small>Déjalo en blanco para generar el sku de forma automática.<small>",
    'shipping' => 'Detalles y cargos de envío. Click en el ícono de editar de abajo para agregar/editar detalles y cargos de envío',
    'tax_rate_options' => 'Se restarán los porcentajes negativos y se sumarán los porcentajes positivos',
    'customer_name_help_text' => "Nombre del cliente que será impreso en el documento",
    'warehouse_select' => 'Bodega de donde el producto será tomado',
    'cashier_select' => 'Caja registradora usada',
    'check_dai' => 'Habilita o deshabilita la edición del DAI en la compra',
    'subtract_sell_return' => 'Restar monto de devoluciones del total mostrado en la caja de cuentas por cobrar',
    'box_exc_tax' => 'Mostrar monto de las cajas y gráficos de ventas y compras sin impuestos',
    'reservation_help_text' => 'Reservas pendientes de facturar',
    'decimals_in_pos_tooltip' => 'Número de decimales que se pueden visualizar en los precios que aparecen en el POS',
    'decimals_in_fiscal_documents_tooltip' => 'Número de decimales que se pueden visualizar en los precios que aparecen en los documentos fiscales',
    'decimals_in_purchases_tooltip' => 'Número de decimales que se pueden visualizar en los costos que aparecen en el módulo de compras',
    'load_in_physical_inventory_tooltip' => 'Número de meses a considerar en opción para cargar automaticamente productos en inventario físico.<br>Ej: Al colocar 2, al marcar la opcion para cargar automaticamente productos en formulario de inventario físico solo se consideraran aquellos productos que hayan tenido rotación en los últimos 2 meses.',
    'show_costs_or_prices_tooltip' => 'Definir si los costos o precios de los productos se muestran u ocultan en los traslados y ajustes de stock',
