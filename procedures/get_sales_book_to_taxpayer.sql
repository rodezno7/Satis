...
BEGIN
	...
	SELECT
        ...
        c.name AS customer,
        IF (t.document_types_id = @ccf, t.total_before_tax, t.total_before_tax * -1) AS internal,
        IF (t.document_types_id = @ccf, t.total_before_tax * 0.13, t.total_before_tax * 0.13 * -1) AS fiscal_debit,
