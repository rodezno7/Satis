...
BEGIN
    ...
    ORDER BY
        ...
        CASE WHEN v_order_column = 4 AND v_order_dir = 'asc' THEN t.payment_status END ASC,
        CASE WHEN v_order_column = 4 AND v_order_dir = 'desc' THEN t.payment_status END DESC,
        CASE WHEN v_order_column = 5 AND v_order_dir = 'asc' THEN tp.method END ASC,
        CASE WHEN v_order_column = 5 AND v_order_dir = 'desc' THEN tp.method END DESC,
        CASE WHEN v_order_column = 6 AND v_order_dir = 'asc' THEN t.total_before_tax END ASC,
        CASE WHEN v_order_column = 6 AND v_order_dir = 'desc' THEN t.total_before_tax END DESC,
        CASE WHEN v_order_column = 7 AND v_order_dir = 'asc' THEN t.discount_amount END ASC,
        CASE WHEN v_order_column = 7 AND v_order_dir = 'desc' THEN t.discount_amount END DESC,
        CASE WHEN v_order_column = 8 AND v_order_dir = 'asc' THEN t.tax_amount END ASC,
        CASE WHEN v_order_column = 8 AND v_order_dir = 'desc' THEN t.tax_amount END DESC,
        CASE WHEN v_order_column = 9 AND v_order_dir = 'asc' THEN t.final_total END ASC,
        CASE WHEN v_order_column = 9 AND v_order_dir = 'desc' THEN t.final_total END DESC
