...
class EntrieReportExport implements FromView, WithEvents, WithTitle
{
    /**
    ...
    */
    ...
    public function __construct($enable_description_line, $datos, $numero, $business_name, $header3)
    {
    ...
    public function registerEvents(): array
    {
    	return [            
    		AfterSheet::class    => function(AfterSheet $event) {
    			...
    			$event->sheet->horizontalAlign('A5:F5' , \PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
    ...
    {
    	return view('reports.entries_excel', [
